...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/milestones-dev.css">
        <!-- Font Family -->
                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <form action="payment-process-v2.php" method="POST" class="my-form pt-5">
                            ...
                            <div class="row mt-4">
                                 <!-- Left Side -->
                                <div class="section-left col-md-6 my-auto text-center">
                                ...
                                <div class="section-right col-md-6">
                                    ...
                                    <div class="touch-bottom mt-4">
                                        ...
                                        <div class="milestone_price">
                                            ...
                                            <div class="price">
                                                <h1><?= number_format( ($price + $taxes)*($milestones_percent[0]/100) ) . ' ' . $currency ?></h1>
                                            </div>
                                        </div>
                                        <?php
                                            } else {
